...
@section('title', $package->name . ($package->nights > 0 ? ' — ' . $package->nights . 'N/' . $package->days . 'D' : '') . ' from Delhi | RK Shah')
@section('meta_description', $package->name . '. ' . ($package->nights > 0 ? $package->nights . ' nights, ' . $package->days . ' days. ' : '') . 'Starting ₹' . ($package->price > 0 ? number_format($package->price) : 'custom') . '/person. Call +91 93245 55165.')
