...
@section('title', $route->from_city . ' to ' . $route->to_city . ' Cab — Starting ₹' . ($route->min_price ? number_format($route->min_price) : 'Get Quote') . ' | RK Shah')
@section('meta_description', 'Book cab from ' . $route->from_city . ' to ' . $route->to_city . '. ' . ($route->distance_km > 0 ? $route->distance_km . ' km, ~' . $route->duration_hrs . ' hrs. ' : '') . 'AC cars, verified drivers. Call +91 93245 55165.')
